import { LineChart, RefreshCw, TrainFront, BusFront, ShieldCheck, Activity, BookOpen, LoaderCircle } from 'lucide-react';
...
export function AnalysisHeader({
  ...
  return (
    <section
      aria-label="Analysis Command Context"
    ...
    >
      ...
      <div className="relative flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div className="min-w-0 space-y-1.5">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-2.5 py-0.5 font-mono-ui text-[9.5px] font-bold uppercase tracking-[0.16em] text-primary">
              ...
              METROMIND / ANALYSE / STATISTICAL INTELLIGENCE
            </span>
          ...
          <div className="pt-1">
            ...
            <p className="mt-1 text-xs text-muted-foreground sm:text-sm leading-relaxed max-w-3xl">
              Measure the relationships, trends, and periodic structure behind passenger demand before forecasting or intervention.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0 self-start md:self-center">
          {/* Status Badge */}
          <div
            data-testid="status-analysis-beacon"
          ...
          >
            ...
            <span>
              {isPending
                ...
                : isError
                ? 'STATISTICAL ERROR'
                : 'MATHEMATICAL PIPELINE: CALIBRATED'}
            </span>
          </div>

          {/* Tutorial Guide Trigger */}
          <Button
            onClick={() => startTutorial(3)}
            variant="outline"
            testId="button-analysis-tutorial"
